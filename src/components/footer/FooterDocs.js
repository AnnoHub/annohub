    ...
    return (
        <div>
            ...
            <u1 className="doc-links">
                <li><a class='footer-text' href={`${process.env.PUBLIC_URL}/docs/T2331_Analysis_and_Requirements_Report.pdf`} target="_blank" rel="noopener noreferrer">Analysis and Requirements Report</a></li>
